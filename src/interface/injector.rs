...
impl InjectorPP {
    ...
    ///
    /// `InjectorPP` allows patching Rust functions at runtime without modifying the original code.
    ...
    /// Begins patching a synchronous function.
    ///
    /// Accepts a raw pointer to the function you want to patch. Use the `func!` macro to obtain this pointer.
    ///
    /// # Parameters
    ///
    ...
    /// # Returns
    ///
    /// A builder (`WhenCalledBuilder`) to further specify the patch behavior.
    ///
    /// # Example
    ///
    /// ```rust
    ...
    /// Begins patching an asynchronous function.
    ///
    ...
    /// # Returns
    ///
    /// A builder (`WhenCalledBuilderAsync`) to further specify the async patch behavior.
    ///
    /// # Example
    ///
    /// ```rust
...
impl WhenCalledBuilder<'_> {
    /// Patches the target function to branch to the provided raw function pointer.
    ///
    /// Allows full customization of the patched function behavior by providing your own function or closure.
    ///
    /// # Parameters
    ///
    ...
    /// Patches the target function using a fake function generated by the `fake!` macro.
    ///
    ...
    /// Patches the target function to always return a fixed boolean value.
    ///
...
impl WhenCalledBuilderAsync<'_> {
    /// Patches the target async function to return a specified async value.
    ///
